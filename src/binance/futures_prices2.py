...
class SingleCoin():
    def __init__(self, client, symbol='', time_frame=1, window=200):
    ...
    def add_price_info(self, df_symbol, window=None):
        ...
        time_normalizing_factor = (df_symbol['close_time'].iloc[-1] - df_symbol['close_time'].iloc[-2]) / (
                int(time_now.timestamp() * 1000) - df_symbol['close_time'].iloc[-2])

        # find percent price change
        df_symbol['price_change'] = (df_symbol['close'].pct_change()).apply(
            lambda x: calculate.round_long_decimals(x, prec=4) if not pd.isna(x) else float('nan')) * 100
...
if __name__ == '__main__':
    ...
    symbol_dic = dic['UXLINKUSDT']
    for term in [200, 100, 50, 25]:
        print(term)
        top_keys = [f'top_ema{term}_dev_mean', f'top_ema{term}_dev_binmode', f'top_ema{term}_dev_median']
        tops = sorted([symbol_dic[key] for key in top_keys])
        print(tops)
        dip_keys = [f'dip_ema{term}_dev_mean', f'dip_ema{term}_dev_binmode', f'dip_ema{term}_dev_median']
        dips = sorted([symbol_dic[key] for key in dip_keys], reverse=True)
        print(dips)
        pos_slope_keys = [f'pos_ema{term}_slope_max', f'pos_ema{term}_slope_mean', f'pos_ema{term}_slope_median', f'pos_ema{term}_slope_binmode', f'pos_ema{term}_slope_binmode90']
        pos_slopes = sorted([symbol_dic[key] for key in pos_slope_keys])
        print(pos_slopes)
        neg_slope_keys = [f'neg_ema{term}_slope_min', f'neg_ema{term}_slope_mean', f'neg_ema{term}_slope_median', f'neg_ema{term}_slope_binmode', f'neg_ema{term}_slope_binmode90']
        neg_slopes = sorted([symbol_dic[key] for key in neg_slope_keys], reverse=True)
        print(neg_slopes)
        pos_pct_change_keys = [f'pos_ema{term}_pct_change_max', f'pos_ema{term}_pct_change_mean', f'pos_ema{term}_pct_change_median', f'pos_ema{term}_pct_change_binmode', f'pos_ema{term}_pct_change_binmode90']
        pos_pct_changes = sorted([symbol_dic[key] for key in pos_pct_change_keys])
        print(pos_pct_changes)
        neg_pct_change_keys = [f'neg_ema{term}_pct_change_min', f'neg_ema{term}_pct_change_mean', f'neg_ema{term}_pct_change_median', f'neg_ema{term}_pct_change_binmode', f'neg_ema{term}_pct_change_binmode90']
        neg_pct_changes = sorted([symbol_dic[key] for key in neg_pct_change_keys], reverse=True)
        print(neg_pct_changes)
    all_keys = ['futures_high', 'futures_low', 'top_ema200_dev_mean', 'top_ema200_dev_binmode', 'top_ema200_dev_median', 'top_ema200_dev_max', 'dip_ema200_dev_mean', 'dip_ema200_dev_binmode', 'dip_ema200_dev_median', 'dip_ema200_dev_min', 'top_ema100_dev_mean', 'top_ema100_dev_binmode', 'top_ema100_dev_median', 'top_ema100_dev_max', 'dip_ema100_dev_mean', 'dip_ema100_dev_binmode', 'dip_ema100_dev_median', 'dip_ema100_dev_min', 'top_ema50_dev_mean', 'top_ema50_dev_binmode', 'top_ema50_dev_median', 'top_ema50_dev_max', 'dip_ema50_dev_mean', 'dip_ema50_dev_binmode', 'dip_ema50_dev_median', 'dip_ema50_dev_min', 'pricePrecision', 'quantityPrecision', 'spot_high', 'spot_low', 'all_high', 'all_low', 'pos_ema200_slope_max', 'pos_ema200_slope_mean', 'pos_ema200_slope_median', 'pos_ema200_slope_binmode', 'pos_ema200_slope_binmode90', 'neg_ema200_slope_min', 'neg_ema200_slope_mean', 'neg_ema200_slope_median', 'neg_ema200_slope_binmode', 'neg_ema200_slope_binmode90', 'pos_ema200_pct_change_max', 'pos_ema200_pct_change_mean', 'pos_ema200_pct_change_median', 'pos_ema200_pct_change_binmode', 'pos_ema200_pct_change_binmode90', 'neg_ema200_pct_change_min', 'neg_ema200_pct_change_mean', 'neg_ema200_pct_change_median', 'neg_ema200_pct_change_binmode', 'neg_ema200_pct_change_binmode90', 'pos_ema100_slope_max', 'pos_ema100_slope_mean', 'pos_ema100_slope_median', 'pos_ema100_slope_binmode', 'pos_ema100_slope_binmode90', 'neg_ema100_slope_min', 'neg_ema100_slope_mean', 'neg_ema100_slope_median', 'neg_ema100_slope_binmode', 'neg_ema100_slope_binmode90', 'pos_ema100_pct_change_max', 'pos_ema100_pct_change_mean', 'pos_ema100_pct_change_median', 'pos_ema100_pct_change_binmode', 'pos_ema100_pct_change_binmode90', 'neg_ema100_pct_change_min', 'neg_ema100_pct_change_mean', 'neg_ema100_pct_change_median', 'neg_ema100_pct_change_binmode', 'neg_ema100_pct_change_binmode90', 'pos_ema50_slope_max', 'pos_ema50_slope_mean', 'pos_ema50_slope_median', 'pos_ema50_slope_binmode', 'pos_ema50_slope_binmode90', 'neg_ema50_slope_min', 'neg_ema50_slope_mean', 'neg_ema50_slope_median', 'neg_ema50_slope_binmode', 'neg_ema50_slope_binmode90', 'pos_ema50_pct_change_max', 'pos_ema50_pct_change_mean', 'pos_ema50_pct_change_median', 'pos_ema50_pct_change_binmode', 'pos_ema50_pct_change_binmode90', 'neg_ema50_pct_change_min', 'neg_ema50_pct_change_mean', 'neg_ema50_pct_change_median', 'neg_ema50_pct_change_binmode', 'neg_ema50_pct_change_binmode90', 'top_ema25_dev_max', 'top_ema25_dev_mean', 'top_ema25_dev_binmode', 'top_ema25_dev_median', 'dip_ema25_dev_min', 'dip_ema25_dev_mean', 'dip_ema25_dev_binmode', 'dip_ema25_dev_median', 'pos_ema25_slope_max', 'pos_ema25_slope_mean', 'pos_ema25_slope_median', 'pos_ema25_slope_binmode', 'pos_ema25_slope_binmode90', 'neg_ema25_slope_min', 'neg_ema25_slope_mean', 'neg_ema25_slope_median', 'neg_ema25_slope_binmode', 'neg_ema25_slope_binmode90', 'pos_ema25_pct_change_max', 'pos_ema25_pct_change_mean', 'pos_ema25_pct_change_median', 'pos_ema25_pct_change_binmode', 'pos_ema25_pct_change_binmode90', 'neg_ema25_pct_change_min', 'neg_ema25_pct_change_mean', 'neg_ema25_pct_change_median', 'neg_ema25_pct_change_binmode', 'neg_ema25_pct_change_binmode90']


    save_load_pkl(coins_dict_pkl_path, dic)
